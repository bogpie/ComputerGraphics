...
void Lab2::Init()
{
	...
	// meshes["tetra"]->InitFromData(verticesTetra, indicesTetra);
	CreateMesh("tetra", verticesTetra, indicesTetra);
	...
	CreateMesh("square", verticesSquare, indicesSquare);
}
...
void Lab2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-3.5f, 0.5f, 0), glm::vec3(0.5f));

	// TODO(student): Draw the square
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-4.5f, 0.5f, 0), glm::vec3(0.5f));
